    ...
    <nav class="navbar navbar-default top-navbar navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li v-if="loginStatus === 'hrd'" v-on:click="chStatePageToHrdRequested(); setActiveSide({loginStatus}+'/'+{statePage}+'/human-resource'); setActive('hrd/requested');" :class="{active: isActive('hrd/requested')}"><router-link to="/hrd/requested/human-resource">Requested</router-link></li>
      ...
      <div class="navbar navbar-inverse navbar-fixed-left">
        <ul class="nav navbar-nav">
            ...
            <li v-if="loginStatus === ''" v-on:click="setActiveSide({statePage}+'/project-management');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/project-management')}"><router-link :to="'/'+statePage+'/project-management'">Project Management</router-link></li>
            <li v-if="loginStatus === ''" v-on:click="setActiveSide({statePage}+'/product-management');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/product-management')}"><router-link :to="'/'+statePage+'/product-management'">Product Management</router-link></li>
            <!---->
            <li v-if="loginStatus === 'hrd' && (statePage === 'requested' || statePage === 'candidates')" v-on:click="setActiveSide({loginStatus}+'/'+{statePage}+'/human-resource');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/human-resource')}"><router-link :to="'/'+loginStatus+'/'+statePage+'/human-resource'">Human Resource</router-link></li>
            <li v-if="loginStatus === 'hrd' && (statePage === 'requested' || statePage === 'candidates')" v-on:click="setActiveSide({loginStatus}+'/'+{statePage}+'/marketing');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/marketing')}"><router-link :to="'/'+loginStatus+'/'+statePage+'/marketing'">Marketing</router-link></li>
            <li v-if="loginStatus === 'hrd' && (statePage === 'requested' || statePage === 'candidates')" v-on:click="setActiveSide({loginStatus}+'/'+{statePage}+'/trade-partnership');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/trade-partnership')}"><router-link :to="'/'+loginStatus+'/'+statePage+'/trade-partnership'">Trade Partnership</router-link></li>
            <li v-if="loginStatus === 'hrd' && (statePage === 'requested' || statePage === 'candidates')" v-on:click="setActiveSide({loginStatus}+'/'+{statePage}+'/operation');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/operation')}"><router-link :to="'/'+loginStatus+'/'+statePage+'/operation'">Operation</router-link></li>
            <li v-if="loginStatus === 'hrd' && (statePage === 'requested' || statePage === 'candidates')" v-on:click="setActiveSide({loginStatus}+'/'+{statePage}+'/technology');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/technology')}"><router-link :to="'/'+loginStatus+'/'+statePage+'/technology'">Technology</router-link></li>
            <li v-if="loginStatus === 'hrd' && (statePage === 'requested' || statePage === 'candidates')" v-on:click="setActiveSide({loginStatus}+'/'+{statePage}+'/business-development');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/business-development')}"><router-link :to="'/'+loginStatus+'/'+statePage+'/business-development'">Business Development</router-link></li>
            <li v-if="loginStatus === 'hrd' && (statePage === 'requested' || statePage === 'candidates')" v-on:click="setActiveSide({loginStatus}+'/'+{statePage}+'/finance');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/finance')}"><router-link :to="'/'+loginStatus+'/'+statePage+'/finance'">Finance</router-link></li>
            <li v-if="loginStatus === 'hrd' && (statePage === 'requested' || statePage === 'candidates')" v-on:click="setActiveSide({loginStatus}+'/'+{statePage}+'/project-management');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/project-management')}"><router-link :to="'/'+loginStatus+'/'+statePage+'/project-management'">Project Management</router-link></li>
            <li v-if="loginStatus === 'hrd' && (statePage === 'requested' || statePage === 'candidates')" v-on:click="setActiveSide({loginStatus}+'/'+{statePage}+'/product-management');" :class="{active: isActiveSide({loginStatus}+'/'+{statePage}+'/product-management')}"><router-link :to="'/'+loginStatus+'/'+statePage+'/product-management'">Product Management</router-link></li>
